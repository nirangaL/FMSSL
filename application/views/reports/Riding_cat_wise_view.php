...
<div class="box box-primary col-sm-12 animated zoomIn">
    <div class="panel panel-body">
        <div class="col-sm-12">
        <form action="<?php echo base_url('reports/RidingCatWise/getData');?>" method="post">
        
        <div class="form-group">
            <label for="bloodg" class="col-sm-2 control-label">Riding Category : </label>
                <div class="col-sm-3">
                    <select name="ridingCat" id="ridingCat" class="form-control" required>
