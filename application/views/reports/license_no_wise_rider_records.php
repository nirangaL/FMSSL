...
<div class="box box-primary col-sm-12 animated zoomIn">
    <div class="panel panel-body">
        <div class="col-sm-12">
        <form action="<?php echo base_url('reports/LicenceNoWiseRIderRecords/getData');?>" method="post">
        
        <div class="form-group">
            <label for="bloodg" class="col-sm-2 control-label">License No : </label>
                <div class="col-sm-3">
                    <select name="licenceNo" id="licenceNo" class="form-control select2" required>
                        <option value="0">All</option>
                        <?php
                        if(!empty($licenceNo)){
                            foreach($licenceNo as $item){
                            ?>
                            <option value="<?php echo $item->licenseNo;?>"  <?php echo set_select('licenceNo',$item->licenseNo); ?> ><?php echo $item->licenseNo;?></option>   
                            <?php
                            }
                        }
                        ?>
