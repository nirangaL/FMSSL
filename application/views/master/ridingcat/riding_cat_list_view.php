...
<div class="box box-primary col-sm-12 animated zoomIn">
    <div class="panel panel-body">
        <div class="col-sm-1">
            <a href="<?php echo base_url('master/ridingcat/add'); ?>" class="btn btn-success  btn-flat" >Add Riding Category </a> 
        </div> 
        <br>
        <br>
        <hr>
                        ...
                        foreach ($categories as $category) {
                            ...
                            <tr>
                                ...
                                <td class="text-blue text-center">                                        
                                    <a type="button" href="<?php echo base_url('master/ridingcat/view').'/'.$category->id; ?>"><i class="fa fa-hand-o-up "></i></a>  
                                </td>
                            </tr>
                            <?php
                        }
