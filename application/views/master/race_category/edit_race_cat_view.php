...
<div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <div class="row">
                ...
                <form role="form" action="<?php echo base_url('master/racecategory/edit/').$category[0]->id;?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="cat_name">Category Name :</label>
                  <input id="cat_name" name="cat_name" type="text" value="<?php echo $category[0]->category; ?>" class="form-control" >
